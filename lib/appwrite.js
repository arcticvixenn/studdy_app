...
const dailyQuestPool = [
  {
    ...
    description: 'Закріпи знання та отримай XP за результат.',
    reward: 70,
    icon: '🧠',
  },
  {
    ...
    description: 'Додай пост або курс у збережене.',
    reward: 35,
    icon: '⭐',
  },
  {
    ...
    description: 'Постав питання або поясни тему під постом.',
    reward: 45,
    icon: '💬',
  },
  {
    ...
    description: 'Відкрий урок або корисну публікацію.',
    reward: 40,
    icon: '📚',
  },
];
