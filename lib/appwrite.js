...
export const createUser = async (email, password, username) => {
  try {
    ...
    throw new Error(error?.message || 'РџРѕРјРёР»РєР° РїС–Рґ С‡Р°СЃ СЂРµС”СЃС‚СЂР°С†С–С—.');
  }
};
...
export const signIn = async (email, password) => {
  try {
    ...
    throw new Error(error?.message || 'РџРѕРјРёР»РєР° РїС–Рґ С‡Р°СЃ РІС…РѕРґСѓ.');
  }
};
...
const uploadWebFile = async (file) => {
  ...
  if (!(browserFile instanceof File)) {
    throw new Error('Р‘СЂР°СѓР·РµСЂ РЅРµ РїРµСЂРµРґР°РІ РєРѕСЂРµРєС‚РЅРёР№ С„Р°Р№Р» РґР»СЏ Р·Р°РІР°РЅС‚Р°Р¶РµРЅРЅСЏ.');
  }
...
const uploadFile = async (file, type) => {
  ...
  try {
    ...
    throw new Error(error?.message || 'РќРµ РІРґР°Р»РѕСЃСЏ Р·Р°РІР°РЅС‚Р°Р¶РёС‚Рё С„Р°Р№Р».');
  }
};
...
export const createPost = async ({
  ...
  if (!user?.$id) {
    throw new Error('РќРµ РІРґР°Р»РѕСЃСЏ РІРёР·РЅР°С‡РёС‚Рё Р°РІС‚РѕСЂР°.');
  }
  ...
  ID.unique(),
  {
    ...
    authorId: user.$id,
    authorName: user.username || 'РљРѕСЂРёСЃС‚СѓРІР°С‡ Studdy',
  ...
  [
    ...
    throw new Error(error?.message || 'РќРµ РІРґР°Р»РѕСЃСЏ СЃС‚РІРѕСЂРёС‚Рё РїСѓР±Р»С–РєР°С†С–СЋ.');
  }
};
...
export const togglePostLike = async ({
  ...
  if (!user?.$id || !user?.accountId) {
    throw new Error('РќРµ РІРґР°Р»РѕСЃСЏ РІРёР·РЅР°С‡РёС‚Рё РєРѕСЂРёСЃС‚СѓРІР°С‡Р°.');
  }
  ...
  try {
    ...
    throw new Error(error?.message || 'РќРµ РІРґР°Р»РѕСЃСЏ Р·РјС–РЅРёС‚Рё Р»Р°Р№Рє.');
  }
};
...
export const togglePostSave = async ({
  ...
  try {
    ...
    throw new Error(error?.message || 'РќРµ РІРґР°Р»РѕСЃСЏ Р·РјС–РЅРёС‚Рё Р·Р±РµСЂРµР¶РµРЅРЅСЏ.');
  }
};
...
export const toggleFollow = async ({
  ...
  try {
    ...
    throw new Error(error?.message || 'РќРµ РІРґР°Р»РѕСЃСЏ Р·РјС–РЅРёС‚Рё РїС–РґРїРёСЃРєСѓ.');
  }
};
...
export const createCourse = async ({
  ...
  if (!user?.$id || !user?.accountId) {
    throw new Error('РќРµ РІРґР°Р»РѕСЃСЏ РІРёР·РЅР°С‡РёС‚Рё Р°РІС‚РѕСЂР° РєСѓСЂСЃСѓ.');
  }
...
export const createLesson = async ({
  ...
  if (!user?.accountId) {
    throw new Error('РќРµ РІРґР°Р»РѕСЃСЏ РІРёР·РЅР°С‡РёС‚Рё Р°РІС‚РѕСЂР° СѓСЂРѕРєСѓ.');
  }
  ...
  try {
    ...
    throw new Error(error?.message || 'РќРµ РІРґР°Р»РѕСЃСЏ СЃС‚РІРѕСЂРёС‚Рё СѓСЂРѕРє.');
  }
};
...
export const createQuiz = async ({
  ...
  if (!user?.accountId) {
    throw new Error('РќРµ РІРґР°Р»РѕСЃСЏ РІРёР·РЅР°С‡РёС‚Рё Р°РІС‚РѕСЂР° С‚РµСЃС‚Сѓ.');
  }
...
export const createQuestion = async ({
  ...
  if (!user?.accountId) {
    throw new Error('РќРµ РІРґР°Р»РѕСЃСЏ РІРёР·РЅР°С‡РёС‚Рё Р°РІС‚РѕСЂР° РїРёС‚Р°РЅРЅСЏ.');
  }
  ...
  try {
    ...
    throw new Error(error?.message || 'РќРµ РІРґР°Р»РѕСЃСЏ СЃС‚РІРѕСЂРёС‚Рё РїРёС‚Р°РЅРЅСЏ.');
  }
};
...
export const getUserLearningStats = async (userId) => {
  ...
  answers.forEach((answer) => {
    const topic = answer.topic || 'Р‘РµР· С‚РµРјРё';
  ...
  const topicStats = Object.values(groupedByTopic)
    .map((item) => {
      ...
      /*
        priorityScore вЂ” С†Рµ РїС–РґРіРѕС‚РѕРІРєР° РґРѕ ML:
        С‡РёРј РЅРёР¶С‡Р° С‚РѕС‡РЅС–СЃС‚СЊ, Р±С–Р»СЊС€Рµ РїРѕРјРёР»РѕРє С– РІРёС‰Р° СЃРєР»Р°РґРЅС–СЃС‚СЊ,
        С‚РёРј РІР°Р¶Р»РёРІС–С€Рµ СЂРµРєРѕРјРµРЅРґСѓРІР°С‚Рё С‚РµРјСѓ РґР»СЏ РїРѕРІС‚РѕСЂРµРЅРЅСЏ.
      */
      const priorityScore =
...
export async function saveMlGeneratedQuiz({
  ...
  if (!user?.accountId) {
    throw new Error('РќРµ РІРґР°Р»РѕСЃСЏ РІРёР·РЅР°С‡РёС‚Рё РєРѕСЂРёСЃС‚СѓРІР°С‡Р° РґР»СЏ Р·Р±РµСЂРµР¶РµРЅРЅСЏ С‚РµСЃС‚Сѓ.');
  }

  const quizDocument = await createQuiz({
    courseId,
    lessonId,
    title: title || 'ML-Р·РіРµРЅРµСЂРѕРІР°РЅРёР№ С‚РµСЃС‚',
    passingScore: 60,
    user,
  });
